    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_photo', models.ImageField(blank=True, null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_username', models.CharField(max_length=256)),
                ('contact_password', models.CharField(max_length=256)),
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='minicrm.agent')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='minicrm.contact')),
            ],
        ),
        migrations.CreateModel(
            name='File',
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='minicrm.message')),
            ],
        ),
    ]
